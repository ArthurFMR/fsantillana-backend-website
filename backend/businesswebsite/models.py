...
class CompanyInfo(models.Model):
    ...
    building_img = models.ImageField(null=True, blank=True, upload_to='images/')
    logo = models.ImageField(upload_to='images/', default='image/logo-default.jpg')
...
class Slides(models.Model):
    ...
    img = models.ImageField(upload_to='images/slides/', default='images/default-slide.jpg')
...
class Services(models.Model):
    ...
    description = models.TextField()
    img = models.ImageField(upload_to='images/services/', default='images/default.png')
